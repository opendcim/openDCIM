...
if ( $person->SiteAdmin ) {
	...
	$samenu[__("Infrastructure Management")][]='<a href="image_management.php#drawings"><span>'.__("Facilities Image Management").'</span></a>';
        ...
        $samenu[__("Measure Management")][]='<a href="measure_point_air.php"><span>'.__("Edit Air Measure Points").'</span></a>';
        $samenu[__("Measure Management")][]='<a href="measure_point_cooling.php"><span>'.__("Edit Cooling Measure Points").'</span></a>';
        $samenu[__("Measure Management")][]='<a href="measure_point_elec.php"><span>'.__("Edit Electrical Measure Points").'</span></a>';
