...
INSERT INTO fac_Config VALUES
	...
	('LDAPServerType', 'OpenLDAP', 'OpenLDAP/AD', 'string', 'OpenLDAP'),
	...
	('LDAPBindDN-AD', '%userid%@opendcim.org', 'DN', 'string', '%userid%@opendcim.org'),
	('LDAPBaseSearch', '(|(uid=%userid%)(&(objectClass=posixGroup)(memberUid=%userid%)))', 'DN', 'string', '(|(uid=%userid%)(&(objectClass=posixGroup)(memberUid=%userid%)))'),
	('LDAPBaseSearch-AD', '(sAMAccountName=%userid%)', 'DN', 'string', '(sAMAccountName=%userid%)'),
