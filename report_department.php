...
class PDF extends FPDF {
  ...
  var $pdfDB;
	...
	function Header() {
		...
		$this->Cell( 50, 6, _('Departmental Contacts Report'), 0, 1, 'L' );
  ...
  function _putcatalog()
  {
	...
	foreach( $deptList as $deptRow ) {
		...
		$headerTags = array( _('Name'), _('UserID'), _('Phone1'), _('Phone2'), _('Phone3'), _('Email') );
