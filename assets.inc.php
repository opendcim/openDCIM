...
class PlannedPath {
	...
	*/
	...
	private function UpdateList () {
		...
		//Compruebo si el puerto del dispositivo actual est� conectado a la conexi�n trasera de un panel
		...
		if ($port->ConnectedDeviceID<>0){
			...
			foreach($dbh->query($sql) as $row){
				//Compruebo si tengo que a�adir esta pareja
				...
				if (isset($this->candidates[$row["DeviceID2"]]) 
					...
					//A�ado directamente el espejo de este puerto
